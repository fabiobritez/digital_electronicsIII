...
validado y el host lo levanta en el próximo sondeo IN. Lo mismo `CMD_CLR_BUF` al leer: hasta que no lo
...
hardware y la lógica de la clase. La clase CDC, por ejemplo, registra ahí su manejador del endpoint
bulk.
