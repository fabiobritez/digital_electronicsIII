...
software (de la libc, módulo 18). Una multiplicación de `float` que en una PC es una instrucción, en
...
3. Investigá cuántas instrucciones genera una multiplicación `float` vs una `int` con
   `arm-none-eabi-objdump -d` (módulo 18).

---

**Anterior:** [11 - static, const, inline y bitfields](./11-static-const-inline-y-bitfields.md) ·
**Siguiente:** [13 - Redirigir printf a la UART](./13-redirigir-printf-a-uart.md)
