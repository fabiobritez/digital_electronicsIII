...
script (módulo 16). Como definiste `_write` propio, el linker usa **el tuyo** en vez del de
...
- **Recomendación: evitá `%f` al depurar.** Imprimí en enteros o en **punto fijo** (milivoltios,
  ...
  [12 - Punto fijo vs flotante](./12-punto-fijo-vs-flotante.md).
...
**Anterior:** [12 - Punto fijo vs flotante](./12-punto-fijo-vs-flotante.md) ·
