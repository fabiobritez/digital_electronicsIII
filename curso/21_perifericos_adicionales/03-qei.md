...
Capítulo 26 del manual. PCONP bit **18** (`PCQEI`). Se complementa muy bien con el **PWM** (módulo 19)
...
(módulo 19) que maneja el driver del motor. Esa es la estructura de un **controlador PID** de motor. El QEI
