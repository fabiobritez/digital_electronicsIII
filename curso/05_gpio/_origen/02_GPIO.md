...
> **IMPORTANTE**: Antes de usar GPIO, **siempre debes configurar PINSEL** para establecer el pin en función GPIO (FUNC_0).
...
> **Importante**: No todos los pines están disponibles en todos los puertos. Consulta la Tabla 8.3 del manual del usuario.
...
> **IMPORTANTE**: Las interrupciones GPIO solo están disponibles en:
...
- **Tutorial anterior**: [PINSEL - Pin Select](../../04_pinsel/_origen/01_PINSEL.md)
- **Siguiente tutorial**: [SYSTICK - System Timer](../../06_systick/_origen/03_SYSTICK.md)
