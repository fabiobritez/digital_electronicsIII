...
**IMPORTANTE:** Si dos canales solicitan el bus simultáneamente, **el canal con número más bajo tiene prioridad**.
...
**IMPORTANTE:** Los burst sizes también son configurados automáticamente por el driver según la tabla `GPDMA_LUTPerBurst`.
...
**IMPORTANTE:** Siempre deshabilita el canal antes de reconfigurar con `GPDMA_Setup()`.
...
**IMPORTANTE:** Para usar DMA con UART, **DEBES habilitar el modo DMA en el FIFO:**
...
**IMPORTANTE:** Las direcciones de los LLI deben ser accesibles durante toda la transferencia (no pueden estar en stack de una función que retorna).
