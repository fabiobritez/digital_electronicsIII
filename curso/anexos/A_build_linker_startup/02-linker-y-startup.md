...
1. Mira el pin **P2.10**: si está bajo, entra en modo **ISP** (grabación por UART0, anexo B) en
...
El linker script y el startup de esta página son **mínimos a propósito**, para que se
entienda la idea. Las versiones de producción, con la tabla de vectores completa de los 35
