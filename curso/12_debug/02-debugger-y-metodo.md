...
Si el programa salta a `HardFault_Handler` (un manejador por defecto que suele ser un `while(1)`),
...
(*bus fault*, *usage fault*, *memory management fault*), pero como sus manejadores no vienen
