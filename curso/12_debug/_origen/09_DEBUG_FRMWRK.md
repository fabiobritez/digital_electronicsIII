...
**NOTA:** Para cambiar el puerto UART, debes modificar este define en el archivo `debug_frmwrk.h`.
...
**IMPORTANTE:** Los números se imprimen con **todos los dígitos**, incluyendo ceros a la izquierda:
