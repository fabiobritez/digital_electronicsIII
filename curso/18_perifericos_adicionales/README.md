# Módulo 18: Periféricos adicionales (plus)
...
- **QEI** es natural si vas a control de motores (combina bien con PWM, módulo 16).
...
**Anterior:** [17 - Hardware y placa](../17_hardware_y_placa/) · **Volver al** [índice del curso](../README.md)
