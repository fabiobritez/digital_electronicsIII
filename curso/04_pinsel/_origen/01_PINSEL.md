...
> **Importante**: Consulta siempre la **Tabla 8.3** del manual del usuario LPC17xx para ver qué pines están físicamente disponibles en el package del LPC1769.
...
**Siguiente tutorial**: [GPIO - General Purpose Input/Output](../../05_gpio/_origen/02_GPIO.md)
