...
> **Importante**: SysTick es parte del Cortex-M3, NO es un periférico del LPC1769. Está disponible en **todos** los microcontroladores Cortex-M3/M4.
...
> Si el tiempo solicitado excede el máximo, la función entra en un **bucle infinito** (error fatal).
...
**Tutorial anterior**: [GPIO - General Purpose Input/Output](../../05_gpio/_origen/02_GPIO.md)
**Siguiente tutorial**: [TIMER - Temporizadores de propósito general](../../08_timers/_origen/04_TIMER.md)
